...
Copy-Item "$src\natural_pos_icon_1778800633980.png" "$dst\icon-512.png" -Force
Copy-Item "$src\natural_pos_maskable_1778800654512.png" "$dst\icon-maskable.png" -Force
Copy-Item "$src\natural_pos_icon_1778800633980.png" "$dst\icon-192.png" -Force
