...
Copy-Item "$src\natura_os_premium_icon_1778822147450.png" "$dst\icon-512.png" -Force
Copy-Item "$src\natura_os_premium_icon_1778822147450.png" "$dst\icon-maskable.png" -Force
Copy-Item "$src\natura_os_premium_icon_1778822147450.png" "$dst\icon-192.png" -Force
